...
from agents.base.llm import OpenAIClient, AnthropicClient, LLMMessage, get_llm_client


@pytest.fixture
def openai_client():
    with patch("agents.base.llm.openai.AsyncOpenAI") as mock:
...
def anthropic_client():
    with patch("agents.base.llm.AsyncAnthropic") as mock:
